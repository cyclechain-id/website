...
const BookingModal = () => {
  ...
  useEffect(() => {
    setIsOpen(location.hash === "#booking");
  }, [location.hash]);
        ...
        <div className="p-8 md:p-10">
          ...
          {success ? (
            <div className="py-12 px-6 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in duration-500 bg-green-50/50 border border-green-100 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold mb-3 text-green-950">
                Request Received
              </h3>
              <p className="text-green-800/80 max-w-[320px] mb-8 leading-relaxed">
                Thank you, {name.split(" ")[0]}! Check your inbox at{" "}
                <strong>{email}</strong>. We've sent a confirmation email with
                next steps.
              </p>
              <Button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-3 flex flex-col">
                  ...
                  <Popover>
                    ...
                    <PopoverContent
                      className="w-auto p-0 rounded-none border-border"
                      align="start"
                    >
                      <Calendar
                        mode="single"
