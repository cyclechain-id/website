  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meridian's comprehensive privacy policy outlining our data collection, usage, and security practices."
        />
      </Helmet>
              ...
              >
                <section id="introduction" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      At Meridian Digital Solutions ("Meridian", "we", "us", or
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80">
                      <li>
                        ...
                        email address, telephone number, company name, and job
                        title that you voluntarily give to us when registering
                        for services, submitting inquiries, or booking
                        consultations.
                      </li>
                      <li>
                        <strong className="text-foreground">
                        ...
                        access our website, such as your IP address, browser
                      ...
                      <li>
                        ...
                        Data related to your payment method (e.g., valid credit
                        card number, card brand, expiration date) that we may
                        collect when you purchase our services. All financial
                        data is stored by our payment processors and we
                ...
                <section id="data-usage" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80">
                      <li>
                        Administer your account and deliver contracted marketing
                        services.
                      </li>
                      <li>
                        Communicate with you regarding updates, service
                        delivery, or account issues.
                      </li>
                      <li>
                        Generate data-driven insights and analytics to improve
                        our marketing strategies.
                      </li>
                      <li>Process payments and refunds.</li>
                      <li>
                        Send you targeted marketing and promotional
                        communications (subject to your consent).
                      </li>
                ...
                <section id="data-security" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      ...
                      measures to help protect your personal information. We
                      employ industry-standard encryption protocols, secure
                      server infrastructure, and strict access controls to
                      prevent unauthorized access, use, or disclosure of your
                      data.
                    </p>
                    <p>
                      While we have taken reasonable steps to secure the
                      personal information you provide to us, please be aware
                      that despite our efforts, no security measures are perfect
                ...
                <section id="user-rights" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      Depending on your location (including under GDPR and CCPA
                      regulations), you may have certain rights regarding your
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80">
                      ...
                      <li>
                        The right to restrict or object to our processing of
                        your personal data.
                      </li>
                    ...
                    <p className="mt-4">
                      ...
                      the information provided in the Contact Information
                      section below.
                    </p>
                  </div>
                </section>
                ...
                <section id="cookies-tracking" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      ...
                      other tracking technologies on our site to help customize
                      our services and improve your experience. When you access
                      our website, your personal information is not collected
                      through the use of tracking technology.
                    </p>
                    <p>
                      You can remove or reject cookies using your browser
                      settings. Please be aware that getting rid of cookies
                ...
                <section id="third-party" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <p>
                      ...
                      (such as Google Analytics, HubSpot, Meta) to allow
                      tracking technologies and remarketing services on the
                      website through the use of first-party cookies and
                      third-party cookies, to, among other things, analyze and
                      track users' use of the website and better understand
                      online activity.
                    </p>
                  </div>
                </section>
                ...
                <section id="data-retention" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      We will only retain your personal information for as long
                ...
                <section id="contact" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      ...
                      Policy, or wish to exercise your privacy rights, please
                      contact us at:
                    </p>
                    <div className="bg-muted/30 p-8 mt-6 border border-border">
                      ...
                      <p>
                        Email:{" "}
                        <a
                          href="mailto:privacy@meridian.com"
                          className="text-foreground hover:underline"
                        >
                          privacy@meridian.com
                        </a>
                      </p>
