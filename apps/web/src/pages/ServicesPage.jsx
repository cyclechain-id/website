...
const ServicesPage = () => {
  ...
  const services = [
    {
      ...
      title: "SEO",
      description:
        "Increase organic visibility and drive qualified traffic. We deploy technical, on-page, and off-page strategies that outrank your competitors and capture high-intent searchers.",
    ...
    },
    {
      ...
      description:
        "Maximize ROI with targeted paid advertising. We design, launch, and ruthlessly optimize paid search and display campaigns to lower your customer acquisition cost.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      features: [
        "Google Ads & Bing Ads",
    ...
    },
    {
      ...
      description:
        "Build engaged communities and drive conversions. We craft paid and organic social strategies that stop the scroll and turn followers into loyal customers.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      features: [
    ...
    },
    {
      ...
      description:
        "Create valuable content that attracts and converts. From long-form blogs to engaging video scripts, we build content engines that establish your brand authority.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      features: [
    ...
    },
    {
      ...
      description:
        "Nurture leads and drive repeat business. We design automated email sequences and broadcast campaigns that deliver personalized messaging at scale.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      features: [
    ...
    },
    {
      ...
      description:
        "Data-driven insights for continuous improvement. We configure advanced tracking so you have crystal clear visibility into exactly what is driving your revenue.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      features: [
  ...
  return (
    <>
      <Helmet>
        <title>Services - Meridian Marketing</title>
        <meta
          name="description"
          content="From SEO and PPC to content and analytics, we offer comprehensive digital marketing services to help you scale your revenue."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mt-20 border-t border-border pt-12">
              <div className="md:col-span-8 md:col-start-5">
                <p className="text-xl md:text-3xl text-muted-foreground leading-relaxed font-light">
                  We offer end-to-end marketing solutions for building brand
                  presence, capturing high-intent demand, and driving long-term
                  revenue growth.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
                Let's discuss how our tailored marketing strategies can help you
                hit your revenue targets this quarter.
              </p>
              <Button
                asChild
                size="lg"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                A disciplined methodology designed to minimize waste and
                maximize returns.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "We dissect your historical data, map your competitive landscape, and build a channel-specific roadmap.",
                },
                {
                  number: "02",
                  title: "Deploy & Test",
                  description:
                    "We launch campaigns with rapid A/B testing frameworks to identify winning creatives and targeting.",
                },
                {
                  number: "03",
                  title: "Scale & Optimize",
                  description:
                    "We double down on the highest ROI channels while ruthlessly cutting underperforming spend.",
                },
              ].map((step, index) => (
                <motion.div
                  key={step.number}
                ...
                >
                  <div className="text-sm font-bold tracking-widest text-muted-foreground mb-6">
                    {step.number}
                  </div>
