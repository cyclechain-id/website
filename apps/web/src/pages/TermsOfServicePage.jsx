  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meridian's Terms of Service outlining user responsibilities, service limitations, and legal agreements."
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 lg:gap-24 print:block">
              ...
              >
                <Card
                  id="introduction"
                  className="scroll-mt-32 rounded-none border-foreground/10 shadow-sm print:border-none print:shadow-none print:p-0"
                >
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      Welcome to Meridian Digital Solutions ("Meridian", "we",
                      "us", or "our"). These Terms of Service ("Terms") govern
                      your access to and use of our website, digital marketing
                      services, consulting, and related products (collectively,
                      the "Services").
                    </p>
                    <p>
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80 print:text-black">
                      <li>
                        ...
                        during the onboarding and ongoing service delivery
                        processes.
                      </li>
                      <li>
                        Maintain the security and confidentiality of any account
                        credentials provided to you.
                      </li>
                      <li>
                        Ensure that any assets, materials, or content you
                        provide for marketing purposes do not infringe upon the
                        intellectual property rights of third parties.
                      </li>
                      <li>
                        Respond promptly to requests for approvals, feedback, or
                        necessary assets required to execute our marketing
                        campaigns.
                      </li>
                    </ul>
                  </CardContent>
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      While Meridian employs industry-best practices and
                      data-driven strategies, digital marketing inherently
                      involves external variables beyond our control (e.g.,
                      Google algorithm updates, competitor actions, platform
                      policy changes).
                    </p>
                    <p>
                      Therefore, we do not guarantee specific financial results,
                      rankings, or conversion rates. All projections or case
                      studies provided are illustrative and do not constitute a
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      <strong>Client Ownership:</strong> Upon full payment for
                      our Services, you retain ownership of all final
                      deliverables, including custom ad creatives, written copy,
                      and specific campaign assets created specifically for your
                      brand.
                    </p>
                    <p>
                      <strong>Meridian Ownership:</strong> Meridian retains all
                      rights, title, and interest in our proprietary
                      methodologies, software, templates, pre-existing
                      materials, and general marketing frameworks used to
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      To the maximum extent permitted by law, Meridian shall not
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80 print:text-black">
                      ...
                      <li>
                        Any conduct or content of any third party or platform
                        (such as Google, Meta, or LinkedIn).
                      </li>
                      <li>
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      Unless otherwise specified in a custom Statement of Work
                      (SOW):
                    </p>
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80 print:text-black">
                      <li>
                        Invoices are due upon receipt or strictly Net 30 days
                        from the invoice date, depending on your account terms.
                      </li>
                      <li>
                        Retainer fees are billed in advance on the 1st of each
                        month.
                      </li>
                      <li>
                      ...
                      <li>
                        Meridian reserves the right to pause campaign management
                        or suspend services if accounts become past due.
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      Either party may terminate month-to-month services with a
                      30-day written notice. For fixed-term contracts,
                      termination terms will be specified in the governing SOW.
                    </p>
                    <p>
                      Upon termination, you remain responsible for any accrued
                      fees, outstanding invoices, and active third-party ad
                      spend commitments up to the effective date of termination.
                    </p>
                  </CardContent>
                </Card>
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      ...
                      San Francisco, California, administered by the American
                      Arbitration Association in accordance with its Commercial
                      Arbitration Rules. Both parties waive the right to a jury
                ...
                >
                  ...
                  <CardContent className="space-y-4 text-muted-foreground leading-relaxed print:text-black">
                    <p>
                      For legal inquiries, notices, or questions regarding these
                    ...
                    <div className="bg-muted/30 p-8 mt-6 border border-border">
                      ...
                      <p>
                        Email:{" "}
                        <a
                          href="mailto:legal@meridian.com"
