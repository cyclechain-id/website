...
const PortfolioPage = () => {
  const projects = [
    {
      ...
      description:
        "Challenge: Low organic visibility and declining traffic. Strategy: Comprehensive technical SEO cleanup paired with a high-intent content marketing strategy.",
    ...
    },
    {
      ...
      description:
        "Challenge: Unsustainably high customer acquisition cost. Strategy: Refined audience targeting, negative keyword expansion, and strict landing page CRO.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
    ...
    },
    {
      ...
      description:
        "Challenge: Stagnant community and low engagement rates. Strategy: Video-first content strategy mixed with active community management and influencer partnerships.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
      metrics: [
        "450% follower growth",
        "8.2% engagement rate",
    ...
    },
    {
      ...
      description:
        "Challenge: Poor brand awareness in a crowded B2B market. Strategy: Educational blog series combined with high-value video assets and lead magnets.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
    ...
    },
    {
      ...
      description:
        "Challenge: Low customer retention and repeat purchase rates. Strategy: Dynamic list segmentation, automated cart recovery, and personalized post-purchase flows.",
      image: "https://images.unsplash.com/photo-1697893156187-8598ba865712",
  ...
  return (
    <>
      <Helmet>
        <title>Case Studies - Meridian Marketing</title>
        <meta
          name="description"
          content="Explore our marketing case studies and see how we've helped companies scale their revenue and dominate their markets."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mt-20 border-t border-border pt-12">
              <div className="md:col-span-8 md:col-start-5">
                <p className="text-xl md:text-3xl text-muted-foreground leading-relaxed font-light">
                  A curated collection of case studies showcasing strategic
                  execution and measurable marketing ROI.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2">
                    <div
                      className={`transform ${project.rotation} hover:rotate-0 hover:-translate-y-2 transition-all duration-700`}
                    >
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
                Schedule a consultation to discuss your growth goals and how we
                can achieve them.
              </p>
              <Button
                asChild
